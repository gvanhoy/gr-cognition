...
# Generated: Tue Oct 10 10:42:06 2017
##################################################
...
class epsilon_greedy_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.cognition_epsilon_greedy_0, 'configuration'), (self.liquiddsp_flex_tx_0, 'configuration'))
        self.msg_connect((self.liquiddsp_flex_rx_0, 'packet_info'), (self.cognition_epsilon_greedy_0, 'packet_info'))
        self.msg_connect((self.liquiddsp_flex_rx_0, 'constellation'), (self.qtgui_const_sink_x_0, 'in'))
...
def main(top_block_cls=epsilon_greedy_loopback, options=None):
